...
On the other hand, the total number of summands in \ref{General component of higher moments in CLT} is at most $n^m$\mn{Actually it's $\binom{n}{m}$}and the summands are bounded for fixed $k$ since $X$ is bounded. Thus if $m$ is strictly less than $k/2$, then the expression 
